...
const PlaceOrder = () => {
  ...
  const { name, minimumOrderQuantity, availableQuantity, unitPrice } =
    selectedTool || {};
  ...
  return (
    <div className='w-50 mx-auto my-5 py-2'>
      ...
      <p className='text-center mb-2'>
        <small className='me-3 text-center'>
      ...
      <form onSubmit={handlePlaceOrder}>
        ...
        {orderPlaced && (
          <p>
            ...
            <Link to='/dashboard/myOrders' className='text-decoration-none'>
              See your orders
            </Link>
          </p>
        )}
        <input
          className='btn btn-secondary d-block w-50 mx-auto mt-2'
          type='submit'
          value='PlaceOrder'
          disabled={disable}
        />
